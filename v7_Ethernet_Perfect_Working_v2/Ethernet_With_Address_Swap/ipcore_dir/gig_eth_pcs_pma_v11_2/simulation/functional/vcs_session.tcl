...
gui_list_add_divider -id Wave.1 -after PCS_PMA_group { Auto_Neg_Signals }
...
gui_list_add -id Wave.1 -after Auto_Neg_Signals {{demo_tb.link_timer_value}}
gui_list_add -id Wave.1 -after Auto_Neg_Signals {{demo_tb.an_interrupt}}
